...
public class HandleTgUpdateService
{
    private readonly ITelegramBotClient _botClient;
    private readonly ILogger<HandleTgUpdateService> _logger;

    public HandleTgUpdateService(ITelegramBotClient botClient, ILogger<HandleTgUpdateService> logger)
    {
